...
public:
	...
	inline au::Quantity<units::Pixels, uint32_t> get_width() const { return size_.width; }

	inline au::Quantity<units::Pixels, uint32_t> get_height() const { return size_.height; }

...
struct PerspectiveProperties {
	au::Quantity<au::Radians, float> fov = au::degrees(45.0F).as(au::radians);
...
public:
	...
	void set_perspective_vertical_fov(au::Quantity<au::Radians, float> fov_rad);
	...
	au::Quantity<au::Radians, float> get_perspective_vertical_fov() const { return perspective_fov_; }
...
private:
	...
	au::Quantity<au::Radians, float> perspective_fov_ = au::degrees(45.0F).as(au::radians);

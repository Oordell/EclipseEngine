...
namespace eclipse {
	...
	static uint32_t ShaderDataTypeSize(ShaderDataType type) {
		...
		switch (type) {
			case floatvec1:	return float_size;
			case floatvec2:	return float_size * 2;
			case floatvec3:	return float_size * 3;
			case floatvec4:	return float_size * 4;
			case floatmat3:	return float_size * 3 * 3;
			case floatmat4:	return float_size * 4 * 4;
			case intvec1:	return float_size;
			case intvec2:	return float_size * 2;
			case intvec3:	return float_size * 3;
			case intvec4:	return float_size * 4;
	...
	struct BufferElement {
		...
		uint32_t get_component_count() const {
			using enum ShaderDataType;
			switch (type) {
				case floatvec1:	return 1;
				case floatvec2:	return 2;
				case floatvec3:	return 3;
				case floatvec4:	return 4;
				case floatmat3:	return 3 * 3;
				case floatmat4:	return 4 * 4;
				case intvec1:	return 1;
				case intvec2:	return 2;
				case intvec3:	return 3;
				case intvec4:	return 4;
				case boolean:	return 1;
			}
			EC_CORE_ASSERT(false, "Unknown shader data type!");
			return 0;

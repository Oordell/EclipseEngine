...
VULKAN_SDK_INSTALLER_URL = (
    "https://sdk.lunarg.com/sdk/download/1.3.280.0/windows/vulkan_sdk.exe"
)
ECLIPSE_VULKAN_VERSION = "1.3.280.0"
VULKAN_SDK_EXE_PATH = "Eclipse/vendor/VulkanSDK/VulkanSDK.exe"
...
def CheckVulkanSDK():
    if VULKAN_SDK is None:
        ...
        InstallVulkanPrompt()
        return False
    elif ECLIPSE_VULKAN_VERSION not in VULKAN_SDK:
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(
            f"You don't have the correct Vulkan SDK version! (Eclipse requires {ECLIPSE_VULKAN_VERSION})"
        )
        InstallVulkanPrompt()
        return False
...
VulkanSDKDebugLibsURL = (
    "https://files.lunarg.com/SDK-1.2.170.0/VulkanSDK-1.2.170.0-DebugLibs.zip"
)
OutputDirectory = "Eclipse/vendor/VulkanSDK"

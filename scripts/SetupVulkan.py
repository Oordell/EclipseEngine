...
class VulkanConfiguration:
    ...
    vulkanDirectory = "./Eclipse/vendor/VulkanSDK"
    ...
    def CheckVulkanSDK(cls):
        ...
        if cls.requiredVulkanVersion not in vulkanSDK:
            print(
                f"You don't have the correct Vulkan SDK version! (Engine requires {cls.requiredVulkanVersion})"
            )
            cls.__InstallVulkanSDK()
            return False
    ...
    def __InstallVulkanSDK(cls):
        ...
        vulkanPath = (
            f"{cls.vulkanDirectory}/VulkanSDK-{cls.installVulkanVersion}-Installer.exe"
        )
